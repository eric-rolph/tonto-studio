...
Existing browser features are independent of that work: all five cabinets generate/process audio; all 90 inputs are patchable; MIDI/microphone/tape, both routing modes, historical converter controls, the matrix, sequencer and persistent patches are functional.
